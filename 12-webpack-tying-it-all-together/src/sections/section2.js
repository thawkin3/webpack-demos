...
const createSection2 = (parentElement) => {
  ...
  section2.innerHTML = 'I am Section 2. I rely on the following third-party dependencies: axios. I don\'t have any shared dependencies with any other sections though.';
